...
FILE_NAME = 'Untitled'                       # Filename without extension
FOLDER_NAME_UNTRANSFORMED = '1/'
FOLDER_NAME_TRANSFORMED = '2/'    # Make sure this folder exists
...
def transform1(FILE_NAME, FOLDER_NAME_UNTRANSFORMED, FOLDER_NAME_TRANSFORMED, CONE_ANGLE, REFINEMENT_ITERATIONS, TRANSFORMATION_TYPE):
    startzeit = time.time()
