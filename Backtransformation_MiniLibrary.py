...
# -----------------------------------------------------------------------------------------
FILE_NAME = 'UntitledG.gcode'      # filename including extension
FOLDER_NAME_UNTRANSFORMED = '3/'                              # name of the subfolder in which the gcode is located
FOLDER_NAME_TRANSFORMED = '4/'
...
def test_bt(one, two, three):
    print('bt'+one+two+three)
...
def backtransform_file(path, cone_type, maximal_length, angle_comp, x_shift, y_shift, cone_angle_deg, z_desired, e_parallel, e_perpendicular, inputfolder, outputfolder):
    """
    ...
    path_write = re.sub(inputfolder, outputfolder, path)
    ...
    return None
def transform2(FILE_NAME, FOLDER_NAME_UNTRANSFORMED, FOLDER_NAME_TRANSFORMED, CONE_ANGLE, CONE_TYPE, FIRST_LAYER_HEIGHT, X_SHIFT, Y_SHIFT):
    starttime = time.time()
    backtransform_file(path=FOLDER_NAME_UNTRANSFORMED + FILE_NAME, cone_type=CONE_TYPE, maximal_length=0.5, angle_comp='radial', x_shift=X_SHIFT, y_shift=Y_SHIFT,
                       cone_angle_deg=CONE_ANGLE, z_desired=FIRST_LAYER_HEIGHT, e_parallel=0, e_perpendicular=0, inputfolder=FOLDER_NAME_UNTRANSFORMED, outputfolder=FOLDER_NAME_TRANSFORMED)
    endtime = time.time()
